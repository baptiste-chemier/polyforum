...
controllers.controller('MonCompteCtrl', ['$rootScope','$scope','$http', 'UsersRest', '$routeParams',
    '$location', '$route',
    function ($rootScope, $scope, $http, UsersRest, $routeParams, $location, $route) {
        ...
        monCompteCtrl.uploadImage = function() {
          var fd = new FormData();
